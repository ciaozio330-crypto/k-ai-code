...
const LANG = {
  IT: {
    ...
    ui: {
      ...
      items: ['ciao', 'Porta questo plugin da Spi…', 'Mod Fabric: aggiungi un m…', 'Perche ottengo NullPointe…', 'nga'],
  ...
  EN: {
    ...
    ui: {
      ...
      items: ['hi', 'Port this plugin from Spi…', 'Fabric mod: add a m…', 'Why do I get NullPointe…', 'nga'],
